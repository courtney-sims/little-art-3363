...
```
npm create cloudflare@latest -- --template=cloudflare/templates/little-art-3363
```

A live public deployment of this template is available at [https://little-art-3363.templates.workers.dev](https://little-art-3363.templates.workers.dev)
